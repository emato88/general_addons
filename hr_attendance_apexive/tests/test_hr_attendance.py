...
class TestHrAttendance(TransactionCase):
    ...
    @mute_logger('odoo.sql_db')
    def test_create_attendance_without_project(self):
        ...
        # Create an attendance record without project
        try:
            self.hr_attendance_model.create({'description': 'Test description',
                                             'employee_id': employee_id.id,
                                             'task_id': task.id,
                                             'check_in': '2024-04-24 08:00:00',
                                             'check_out': '2024-04-24 17:00:00',
    ...
    @mute_logger('odoo.sql_db')
    def test_create_attendance_without_task(self):
        ...
        # Create an attendance record without task
        try:
            self.hr_attendance_model.create({'description': 'Test description',
                                             'employee_id': employee_id.id,
                                             'project_id': project.id,
    ...
    @mute_logger('odoo.sql_db')
    def test_create_attendance_without_description(self):
        ...
        try:
            self.hr_attendance_model.create({'employee_id': employee_id.id,
                                             'project_id': project.id,
                                             'task_id': task.id,
                                             'check_in': '2024-04-24 08:00:00',
                                             'check_out': '2024-04-24 17:00:00',
